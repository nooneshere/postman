                                    	...
                                    	<tr>
                                        	<td valign="top">
                                            	<div mc:edit="std_preheader_content">
                                                	 Use this area to offer a short teaser of your emails content. Text here will show in the preview area of some email clients.
                                                </div>
                                            </td>
                                            <!-- *|IFNOT:ARCHIVE_PAGE|* -->
                                                	...
                                                	<tr>
                                                    	<td valign="top" class="sidebarContent">
                                                            ...
                                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                <tr mc:repeatable>
                                                                    <td valign="top">
                                                                        <img src="http://yclean.nl/images/main-logo.png" style="max-width:160px;" mc:label="image" mc:edit="tiwc200_image00" />
...
//		$email = new Mail_Postmark();
		...
		$email->addTo('spectrumin.ajay@gmail.com','Ajay aneja')
			->addTo('ajay.work11@gmail.com','Ajay aneja')
					->subject('Test mail from GoDaddy via Postmark')
					//->messagePlain('Plain text message')
					->messageHtml($mailContent);
		//			->send();
